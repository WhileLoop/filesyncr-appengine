...
(function (root, factory) {
  ...
  function _introForElement(targetElm) {
    ...
    if(_addOverlayLayer.call(self, targetElm)) {
      ...
      self._onResize = function(e) {
		...
		_setHelperLayerPosition.call(self, document.querySelector('.introjs-modalOverlay'));
      };
  ...
  function _exitIntro(targetElement) {
	...
	//remove all helper layers
    var modalOverlay = targetElement.querySelector('.introjs-modalOverlay');
    if (modalOverlay) {
  ...
  function _showElement(targetElement) {
    ...
    var self = this,
		...
		modalOverlay = document.querySelector('.introjs-modalOverlay'),
    ...
    if(oldHelperLayer != null) {
	  ...
	  _setHelperLayerPosition.call(self, modalOverlay);
	  ...
	  modalOverlay.className = 'introjs-modalOverlay';
	  ...
	  this._targetElement.appendChild(modalOverlay);
